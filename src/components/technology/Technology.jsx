...
export default function Technology() {
    ...
    return (
        <div style={backgroundImageStyle} className="pt-16 min-h-screen md:pt-32  lg:pl-[7rem] lg:h-screen lg:pt-[10rem]">
            <div className=" lg:flex lg:flex-col lg:justify-between">
                ...
                <div className="flex flex-col justify-between  items-center lg:flex-row lg:h-full">
                    ...
                    <div className="flex order-2 mt-8 mb-6 lg:flex-col gap-8 md:mb-11 lg:ml-8 lg:order-1 lg:my-0">
                    ...
                    <div className="flex items-center flex-col order-3 max-w-[470px] lg:order-2">
                    ...
                    <div className="order-1 w-full md:mb-[60px]   lg:order-3 lg:m-0 lg:w-auto">
